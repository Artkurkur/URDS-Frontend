...
const ResearchProposalModal = ({ isOpen, onClose }) => {
...
Office: University Research and Development Services Office
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="absolute left-0 top-0 h-full w-8 bg-gradient-to-b from-green-400 to-green-600 z-10"></div>

      {/* Back Button */}
      <button 
        onClick={onClose}
        className="absolute left-12 top-8 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 z-10"
      >
        <ChevronLeft className="w-6 h-6 text-gray-700" />
      </button>

      {/* Modal */}
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden z-20">
        {/* Header */}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Research Proposal System</h1>
        <p className="text-gray-600 mb-8">Click the button below to view the submission guidelines</p>
        <button
