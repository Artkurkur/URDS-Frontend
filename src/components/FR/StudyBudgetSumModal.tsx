...
// Extended state to match all tabs
interface StudyState {
  ...
  // Dynamic keys for budget table
  [key: string]: string | number | undefined | null; 
}

interface StudyBudgetSumModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSaveDraft: () => void;
  onSubmit: () => void;
...
export default function StudyBudgetSumModal({ 
  isOpen, 
  onClose, 
  onSaveDraft, 
  onSubmit, 
  ...
  // --- RENDER BUDGET SUMMARY TAB (MATCHING YOUR IMAGE) ---
      ...
      return (
        <tr className="text-sm text-gray-900 border-b border-gray-400">
          ...
          <td className="p-0 border-r border-gray-400 w-32">
            <input 
              type="number" 
              className="w-full h-full p-1 text-right outline-none focus:bg-yellow-50 placeholder-gray-400"
              placeholder={placeholder1}
              value={newStudy[`${key}_y1`] || ""}
          ...
          <td className="p-0 border-r border-gray-400 w-32">
            <input 
              ...
              value={newStudy[`${key}_y2`] || ""}
              onChange={(e) => handleChange(`${key}_y2`, e.target.value)}
            />
          </td>
          <td className="p-1 text-right font-semibold w-32 pr-2">
    ...
    return (
      <div className="border-2 border-gray-900">
        <div className="bg-white p-4 text-center border-b-2 border-gray-900">
          ...
          <h3 className="text-md font-bold text-gray-900">(Budget Summary)</h3>
        </div>
        ...
        <div className="overflow-x-auto border-t-2 border-gray-900">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {/* I. Personal Services */}
              <tr className="bg-white font-bold text-sm text-gray-900 border-b border-gray-400">
                <td colSpan={4} className="p-1 pl-2">I. Personal Services</td>
              </tr>
              ...
              {/* II. MOOE */}
              <tr className="bg-white font-bold text-sm text-gray-900 border-b border-gray-400">
                <td colSpan={4} className="p-1 pl-2">II. MOOE</td>
              </tr>
              ...
              <tr className="bg-white font-bold text-sm text-gray-900 border-b border-gray-400">
                <td colSpan={4} className="p-1 pl-2">III. Equipment Outlay</td>
              </tr>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 font-sans">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[95vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 pb-2">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Add New Study</h2>
        </div>
